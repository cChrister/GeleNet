...
class GeleNet(nn.Module):
    def __init__(self, channel=32):
        ...
        self.ChannelNormalization_v2 = BasicConv2d(256, channel, 3, 1, 1)  # 64x88x88->32x88x88
        ...
        self.ChannelNormalization_t2 = BasicConv2d(128, channel, 3, 1, 1)  # 64x88x88->32x88x88
        ...
        self.KTM4 = KTM(channel)

        self.PDecoder = aggregation(channel)
    ...
    def forward(self, x):
        ...
        v2_nor = self.ChannelNormalization_v2(v2) # 32x44x44
        v3_nor = self.ChannelNormalization_v3(v3) # 32x22x22
        v4_nor = self.ChannelNormalization_v4(v4) # 32x11x11
        t1_nor = self.ChannelNormalization_t1(t1) # 32x44x44
        t2_nor = self.ChannelNormalization_t2(t2) # 32x88x88
        ...
        vt2_KTM = self.KTM2(v2_nor, t2_nor) # 32x44x44
        vt3_KTM = self.KTM3(v3_nor, t3_nor) # 32x22x22
        vt4_KTM = self.KTM4(v4_nor, t4_nor) # 32x11x11


        prediction = self.upsample_4(self.PDecoder(vt4_KTM, vt3_KTM, vt2_KTM, vt1_KTM))
